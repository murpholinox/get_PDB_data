...
El proyecto SIFTS (del inglés _structure integration with function, taxonomy and sequence_), provee, entre otras funciones, un mapeo entre entradas del PDB y UniProt. Dicho mapeo se usa para iniciar el análisis que se detalla a continuación.
